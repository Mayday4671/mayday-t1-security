<template>
  <div class="page-container">
    ...
    <a-modal v-model:open="formVisible" :title="formTitle" @ok="handleSubmit" :confirmLoading="submitting">
      <a-form :model="formData" layout="vertical">
        ...
        <a-form-item label="新密码" v-if="formData.id">
          <a-input-password v-model:value="formData.password" placeholder="不修改请留空" />
        </a-form-item>
        ...
        <a-form-item label="部门">
          <a-select v-model:value="formData.deptIds" mode="multiple" placeholder="请选择部门">
    ...
    <!-- 分配角色弹窗 -->
    <a-modal v-model:open="roleVisible" title="分配角色" @ok="handleRoleSubmit" :confirmLoading="submitting">
